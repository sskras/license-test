...
query "${GH_QUERY}&per_page=${GH_PER_PAGE}&page=1" | jq length
query "${GH_QUERY}&per_page=${GH_PER_PAGE}&page=2"
query "${GH_QUERY}&per_page=${GH_PER_PAGE}&page=2" | jq length
query "${GH_QUERY}&per_page=${GH_PER_PAGE}&page=3"
query "${GH_QUERY}&per_page=${GH_PER_PAGE}&page=3" | jq length
